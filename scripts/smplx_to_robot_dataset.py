...
def main():
    ...
    file_paths = src_folder.rglob("*_stageii.npz")
    for file_path in tqdm(sorted(file_paths), desc="Retargeting files"):
        ...
        if tgt_file_path.exists() and not args.override:
            ...
            continue
        args_list.append((str(file_path), str(tgt_file_path), args.robot, SMPLX_FOLDER, tgt_folder))
